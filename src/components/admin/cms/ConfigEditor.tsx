...
function DeployBadge({ state }: { state: string }) {
    if (state === 'READY') return <span className="inline-flex items-center gap-1.5 px-2.5 py-1 text-xs font-bold uppercase tracking-wider rounded border bg-slate-100 text-slate-800 border-slate-200"><span className="w-1.5 h-1.5 rounded-full bg-slate-500"></span>Concluído</span>;
    ...
    if (state === 'BUILDING') return <span className="inline-flex items-center gap-1.5 px-2.5 py-1 text-xs font-bold uppercase tracking-wider rounded border bg-slate-100 text-slate-800 border-slate-200 animate-pulse"><span className="w-1.5 h-1.5 rounded-full bg-slate-500"></span>Processando</span>;
                                        ...
                                        <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
                                            <div>
                                                ...
                                                <div className="flex items-center gap-2 text-xs mb-3">
                                                    ...
                                                    {(dom.verified && !dom.misconfigured) ? (
                                                        <span className="px-2 py-0.5 bg-slate-100 text-emerald-700 font-bold rounded uppercase tracking-wide flex items-center gap-1">
                                                            <span className="w-1.5 h-1.5 rounded-full bg-slate-500"></span> Verificado
                                                        </span>
                                                    ) : (
                                                        <span className="px-2 py-0.5 bg-slate-100 text-amber-700 font-bold rounded uppercase tracking-wide flex items-center gap-1 border border-slate-200">
                                                            <span className="w-1.5 h-1.5 rounded-full bg-slate-500 animate-pulse"></span> Configuração Pendente
                                                        </span>
                                                    )}
                                                </div>
